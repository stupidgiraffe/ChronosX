...
enum class HookSurface(
    ...
    GREGORIAN_CALENDAR_CONSTRUCTOR("GregorianCalendar.<init>()", ClockDomain.WALL, 27, "real / offset / fixed"),
    ICU_CALENDAR_GET_INSTANCE("android.icu.util.Calendar.getInstance", ClockDomain.WALL, 27, "real / offset / fixed"),
    ...
    LOCAL_DATE_NOW_ZONE("LocalDate.now(ZoneId)", ClockDomain.WALL, 27, "virtual wall clock and explicit zone"),
    LOCAL_DATE_TIME_NOW("LocalDateTime.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    LOCAL_DATE_TIME_NOW_ZONE("LocalDateTime.now(ZoneId)", ClockDomain.WALL, 27, "virtual wall clock and explicit zone"),
    OFFSET_DATE_TIME_NOW("OffsetDateTime.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    OFFSET_DATE_TIME_NOW_ZONE("OffsetDateTime.now(ZoneId)", ClockDomain.WALL, 27, "virtual wall clock and explicit zone"),
    ZONED_DATE_TIME_NOW("ZonedDateTime.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    ZONED_DATE_TIME_NOW_ZONE("ZonedDateTime.now(ZoneId)", ClockDomain.WALL, 27, "virtual wall clock and explicit zone"),
    YEAR_NOW("Year.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    YEAR_MONTH_NOW("YearMonth.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    MONTH_DAY_NOW("MonthDay.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    JAPANESE_DATE_NOW("JapaneseDate.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    HIJRAH_DATE_NOW("HijrahDate.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    MINGUO_DATE_NOW("MinguoDate.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    THAI_BUDDHIST_DATE_NOW("ThaiBuddhistDate.now", ClockDomain.WALL, 27, "virtual wall clock and default zone"),
    ...
    ICU_TIME_ZONE_DEFAULT("android.icu.util.TimeZone.getDefault", ClockDomain.ZONE, 27, "physical or virtual default zone"),
